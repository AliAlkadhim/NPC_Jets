...
# ON DUST
current_dir=/nfs/dust/cms/user/aalkadhi/PYTHIA_STANDALONE/some_run

mkdir -p /nfs/dust/cms/user/aalkadhi/PYTHIA_STANDALONE/some_run/run_${rnd}

#go to the run directory
cd /nfs/dust/cms/user/aalkadhi/PYTHIA_STANDALONE/some_run/run_${rnd}
...
cp /nfs/dust/cms/user/aalkadhi/PYTHIA_STANDALONE/some_run/pythia_standalone_scripts/* .


#CHANGE THE RANDOM SEEDS
sed -i "s;Random:seed=1234;Random:seed=${rnd};g" main42_prehadron.cmnd
sed -i "s;Random:seed=1234;Random:seed=${rnd};g" main42_posthadron.cmnd
...
mv prehadron${rnd}.yoda /nfs/dust/cms/user/aalkadhi/PYTHIA_STANDALONE/some_run/COMPLETE_YODAS/PREHADRON/
...
rm posthadron${rnd}.fifo
#copy the yoda hist file into COMPLETE_YODAS dir
mv posthadron${rnd}.yoda /nfs/dust/cms/user/aalkadhi/PYTHIA_STANDALONE/some_run/COMPLETE_YODAS/POSTHADRON/


echo $1,$rnd
#Finally, go back to current_dir
cd /nfs/dust/cms/user/aalkadhi/PYTHIA_STANDALONE/some_run
