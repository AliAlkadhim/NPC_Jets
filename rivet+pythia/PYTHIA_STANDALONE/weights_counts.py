...
elif SLICE=='Monash_HardQCD_1B':
    dir = 'Monash_HardQCD_1B'
    fig_title=' Pythia Standalone Monash_HardQCD_1B, 1B Events, AK4 $0 \le | y| \le 0.5$'
    post_yoda = 'Monash_HardQCD_1B_posthadron_merged.yoda'
    pre_yoda='Monash_HardQCD_1B_prehadron_merged.yoda'
...
ax2.scatter(edges_low_l_pre, ratio, linewidth=0.5, label=r'$NPC$ ',alpha=0.4, color='blue')
print('ratio = ', ratio)
...
# plt.show()
plt.savefig(str(SLICE)+'_1B_Neff.png')
