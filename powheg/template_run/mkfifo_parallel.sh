...
# ON DUST
current_dir=/nfs/dust/cms/user/aalkadhi/suppr_250_500M/
#go to the run directory
cd /nfs/dust/cms/user/aalkadhi/suppr_250_500M/run_${rnd}
...
cp /nfs/dust/cms/user/aalkadhi/suppr_250_500M/main_scripts/* .
...
#mv prehadron${rnd}.yoda /nfs/dust/cms/user/aalkadhi/suppr_250_500M/COMPLETE_YODAS/PREHADRON/
...
#copy the yoda hist file into COMPLETE_YODAS dir
mv posthadron${rnd}.yoda /nfs/dust/cms/user/aalkadhi/suppr_250_500M/COMPLETE_YODAS/POSTHADRON/
...
cd /nfs/dust/cms/user/aalkadhi/suppr_250_500M/
